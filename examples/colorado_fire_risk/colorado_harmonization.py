...
2. MACAv2 Winter Precipitation (raster) — CCSM4 RCP8.5 Dec–Mar mean, 2006–2099
   ...
   Subsetted to Colorado before transfer; resampled from ~4 km to ~270 m using bilinear interpolation.
...
- CRS: EPSG:4326
- Extent: Colorado
- Resolution: ~270 m (0.00243°, approximated for Colorado latitude)
"""
